...
namespace SadConsole.ConsolesNS
{
    ...
    /// </summary>
    [DataContract]
    public class ConsoleData : IEnumerable<Cell>, IConsoleDataRenderData
    {
        ...
        public Font2 Font { get { return _font; } set { _font = value; SetRenderData(); } }
        #endregion
        ...
        public ConsoleData(int width, int height, Font2 font)
        {
        ...
        public void Copy(ConsoleData destination)
        {
        ...
        /// <param name="destination">The destination surface.</param>
        public void Copy(ConsoleData destination, int x, int y)
        {
        ...
        /// <param name="destination">The destination surface.</param>
        public void Copy(int x, int y, ConsoleData destination)
        {
        ...
        /// <param name="destination">The destination surface.</param>
        public void Copy(int x, int y, int width, int height, ConsoleData destination)
        {
        ...
        public void Copy(int x, int y, int width, int height, ConsoleData destination, int destinationX, int destinationY)
        {
        ...
        public void ShiftUp(int amount, bool wrap = false)
        {
            ...
            if (ResizeOnShift)
            {
                ConsoleData copy = new ConsoleData(_width, _height, _font);
                Copy(copy);
        ...
        public void ShiftLeft(int amount, bool wrap = false)
        {
            ...
            if (ResizeOnShift)
            {
                var copy = new ConsoleData(_width, _height, _font);
                Copy(copy);
                Resize(_width + amount, _height);
                copy.Copy(this, 0, 0);
            }
        ...
        {
            SadConsole.Serializer.Save<ConsoleData>(this, file);
        }

        public static ConsoleData Load(string file)
        {
            return SadConsole.Serializer.Load<ConsoleData>(file);
        }
